...
class FabActions {
  ...
  static FabMenuAction _addDealAction(BuildContext context, VoidCallback onTapItem) => FabMenuAction(
    label: 'Add Deal',
    ...
    onTap: () async {
      ...
      if (state is EnquiryDetailsLoaded) {
        ...
        if (added == true) router.pushNamed(AppRoutes.deals);
      }
    },
  );

  static FabMenuAction _addTaskAction(BuildContext context, VoidCallback onTapItem) => FabMenuAction(
    label: 'Add Task',
  ...
  static FabMenuAction _addCallLogAction(BuildContext context, VoidCallback onTapItem) => FabMenuAction(
    label: 'Add Call Log',
  ...
  static FabMenuAction _deleteAction(BuildContext context, VoidCallback onTapItem) => FabMenuAction(
    label: 'Delete',
    icon: Icons.delete,
