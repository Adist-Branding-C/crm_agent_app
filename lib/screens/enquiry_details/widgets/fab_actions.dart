...
import '../../tasks/widgets/tasks_header_actions.dart';
...
class FabActions {
  ...
  static List<FabMenuAction> build(
  ...
  static FabMenuAction _addDealAction(
    BuildContext context,
    VoidCallback onTapItem,
  ) => FabMenuAction(
    label: 'Add Deal',
  ...
  static FabMenuAction _addTaskAction(
    BuildContext context,
    VoidCallback onTapItem,
  ) => FabMenuAction(
    label: 'Add Task',
  ...
  static FabMenuAction _addCallLogAction(
    BuildContext context,
    VoidCallback onTapItem,
  ) => FabMenuAction(
    label: 'Add Call Log',
    ...
    onTap: () {
      ...
      if (s is EnquiryDetailsLoaded)
        context.pushNamed(AppRoutes.callLog, extra: s.lead);
    },
  );

  static FabMenuAction _deleteAction(
    BuildContext context,
    VoidCallback onTapItem,
  ) => FabMenuAction(
    label: 'Delete',
