          ...
          children: [
            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  FilterSheetAllLeadsRow(isSelected: selectedLead == 'All leads', onTap: () => onSelected('All leads')),
                  ...availableLeads.map((n) => FilterSheetLeadRow(name: n, isSelected: selectedLead == n, onTap: () => onSelected(n))),
                ],
              ),
            ),
          ],
