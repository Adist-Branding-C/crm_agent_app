  ...
  List<WhatsAppTemplateModel> getTemplates() {
    return const [
      WhatsAppTemplateModel(
        id: 'welcome', title: 'Welcome / Intro',
      ...
      WhatsAppTemplateModel(
        id: 'follow_up', title: 'Follow-up reminder',
      ...
      WhatsAppTemplateModel(
        id: 'demo_invite', title: 'Demo invite',
      ...
      WhatsAppTemplateModel(
        id: 'document_request', title: 'Document request',
