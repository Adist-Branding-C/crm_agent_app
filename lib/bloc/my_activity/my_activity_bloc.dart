...
class MyActivityBloc extends Bloc<MyActivityEvent, MyActivityState> {
  ...
  MyActivityBloc({required this.repository, required this.leadsRepository})
    ...
    on<TimeFilterChanged>((e, emit) => myActivityTimeFilterChanged(this, e, emit));
    on<TypeFilterChanged>((e, emit) => myActivityTypeFilterChanged(this, e, emit));
    on<LeadFilterChanged>((e, emit) => myActivityLeadFilterChanged(this, e, emit));
  }
}
