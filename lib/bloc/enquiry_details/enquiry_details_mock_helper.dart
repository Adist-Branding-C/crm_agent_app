...
class EnquiryDetailsMockHelper {
  ...
  static List<EnquiryActivity> getActivities(String leadName) => [
    const EnquiryActivity(
      ...
      remark: 'The candidate is interested in joining the upcoming batch. Discussed course structure and fee breakdown. They asked to call back on Thursday to confirm payment. Follow-up email sent with brochure.',
