...
class ChangePasswordBloc
  ...
  ChangePasswordBloc({required this.authRepository})
    ...
    on<CurrentPasswordChanged>(
      (e, emit) => changePasswordCurrentPasswordChanged(this, e, emit),
    );
    on<NewPasswordChanged>(
      (e, emit) => changePasswordNewPasswordChanged(this, e, emit),
    );
    on<ConfirmPasswordChanged>(
      (e, emit) => changePasswordConfirmPasswordChanged(this, e, emit),
    );
    on<ToggleCurrentPasswordVisibility>(
      (e, emit) => changePasswordToggleCurrentVisibility(this, emit),
    );
    on<ToggleNewPasswordVisibility>(
      (e, emit) => changePasswordToggleNewVisibility(this, emit),
    );
    on<ToggleConfirmPasswordVisibility>(
      (e, emit) => changePasswordToggleConfirmVisibility(this, emit),
    );
    on<ChangePasswordSubmitted>(
      (e, emit) => changePasswordSubmitted(this, e, emit),
    );
  }
}
