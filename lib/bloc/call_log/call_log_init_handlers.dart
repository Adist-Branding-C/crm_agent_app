...
extension CallLogInitHandlers on CallLogBloc {
  ...
  void onAppReturnedFromCall(
    AppReturnedFromCall ev,
    Emitter<CallLogState> emit,
  ) {
    final s = state;
